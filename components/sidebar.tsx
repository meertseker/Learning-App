    ...
    return (
        <div className={cn("flex h-full lg:w-[256px] lg:fixed left-0 top-0 px-4 border-r-2 flex-col", className)}>
            ...
            <div className="flex flex-col gap-y-2 flex-1">
                ...
                <SidebarItem label = "Library" iconSrc = "/library.svg" href = "/library"/>
                <SidebarItem label = "Create" iconSrc = "/create.svg" href = "/create"/>
                <SidebarItem label = "Homepage" iconSrc = "/homepage.svg" href = "/"/>
